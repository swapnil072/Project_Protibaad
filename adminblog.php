...
if(
    ...
    ?>
                   ...
                   <br>   <br>   <br>   <br>   <br>  
                 <h2>Upload BLOG: <a href="adminblogpost.php">Create Blog </a>   </h2><br><br>  
                <h1> Blogs </h1>
                                ...
                                if($returnobj->rowCount()==0){
                                    ...
                                    foreach($returntable as $row){
                                        ...
                                        <tr>
                                            ...
                                            <br><br>
                                                    <input type="button" id="button" value="APPROVE" onclick="approveAlert(<?php echo $row['file_id'] ?>);">
                                                    <br><br>
                                                    <input type="button" id="button" value="DELETE" onclick="deleteAlert(<?php echo $row['file_id'] ?>);">
                                                    <br><br>
                                            </td>
               ...
               <script>
                        ...
                        location.assign('approve_blog.php?id='+id);
                    }

                    function deleteAlert(id){
                        location.assign('delete_blog.php?id='+id);
                    }
               </script>
